<template><div><h1 id="_6-笔记的终极形态" tabindex="-1"><a class="header-anchor" href="#_6-笔记的终极形态"><span>6.笔记的终极形态</span></a></h1>
...
<h2 id="本文重点" tabindex="-1"><a class="header-anchor" href="#本文重点"><span>本文重点</span></a></h2>
<p>一共三个 VSCode 插件</p>
<blockquote>
...
开源的思维导图工具。作者基于源码 fork 进行优化，支持直接以 <code v-pre>*.km.svg</code> 的形式进行直接编辑和保存。</p>
</blockquote>
<blockquote>
...
开源的流程图绘制工具，支持直接以 <code v-pre>.drawio.svg</code>的文件形式直接进行保存。</p>
</blockquote>
...
<h2 id="在线笔记" tabindex="-1"><a class="header-anchor" href="#在线笔记"><span>在线笔记</span></a></h2>
...
<em>这里不得不提一嘴 <code v-pre>语雀 </code>和 <code v-pre>金山文档</code> 的流程图和思维导图工具，体验感拉满</em></p>
</li>
</ol>
...
<p><code v-pre>语雀</code>，国内阿里的，而且不开会员无法在线共享。体验虽好，但是就因为你是国内的在线文档，还无法免费共享。这个就直接 pass 了</p>
<p><code v-pre>腾讯文档</code>，免费，但是体验太差了。不带流程图和思维导图。pass</p>
<p><code v-pre>金山文档</code>，免费，可以直接在线共享，只是存储空间非常小，感觉不太够用。</p>
<p>然后，等到哪一天你想迁移你的文档了，那简直就是灾难！</p>
<hr>
<p>在线文档这块，</p>
<p>如果对流程图和思维导图没有非得内置的强制要求，首先推荐 <code v-pre>office</code>。</p>
<p>如果对墙有要求，首推 <code v-pre>语雀</code>。</p>
<p>如果在线共享需求强烈的，墙内推荐 金山文档 ，墙外推荐 <code v-pre>office</code></p>
<p>如果想免费在线分享编辑推荐 <code v-pre>金山文档</code> 。讲真，WPS 会员还是很香的（前提是微软倒闭，或者 Microsoft 365 突然出现不合理的收费）</p>
<p>如果想在墙内线分享，且不差钱，<code v-pre>语雀</code>。</p>
<p>如果飞书账号在国内进行了企业认证，然后分享的内容不涉及任何敏感话题，且分享范围很小，依然首推<code v-pre>飞书</code>。</p>
<p>(飞书的封禁很严格，你对外分享的文档里面有任何可以的文字就会被封禁，金山文档和语雀，只要不涉及敏感话题都没啥太大的问题)</p>
<p>但是吧，啥玩意儿是敏感话题，你说了不算。言论自由压根不存在的。</p>
<p>PS: 根据调查，文档出了问题 <code v-pre>金山文档</code> 和 <code v-pre>语雀</code> 会直接屏蔽对应文档的在线分享链接，你的文档你依然可以打开。但是飞书是直接没收，账户无法登录！。</p>
<blockquote>
<p><strong>我特么近百篇文档笔记流程图思维导图全都没了！！！</strong><br>
在线笔记这块，我十分不推荐使用，还是 Github 和本地笔记软件用着安心。<br>
如果非得在线共享，建议生成 pdf 或者本地保留副本。</p>
</blockquote>
<h2 id="本地笔记" tabindex="-1"><a class="header-anchor" href="#本地笔记"><span>本地笔记</span></a></h2>
<p>Markdown 基本上是首选。(OneNote 这玩意儿我只想说呵呵~)</p>
<p>md 是一种很干净的文本格式，任何软件都能打开它，即使没有软件渲染也不影响阅读。并且，几乎所有的平台都支持 Markdown 的语法跟格式，Markdown 写作的笔记可以无需任何更改就可以发表到任何平台而保证格式不乱。</p>
<p>但是，md 也会存在一些致命的缺点：</p>
<ul>
<li>无法内置图片，单独一个主文件图像会无法显示</li>
<li>语法需要一点点学习成本</li>
<li>它的呈现效果取决于渲染器是什么样</li>
<li>无法在线分享和多人协作编辑</li>
</ul>
<p>但是，它的优点是无法让人拒绝的。而且它直接支持 HTML 和 CSS，对于一个前端来说，这是十分强大的。</p>
<p>只要解决了图床问题，md 单文件就可以无需改动随处分发。</p>
<p>md 的渲染器大多都是开源的，而且标准大多数都是统一的，也就是说，你无须担心自己的文档无法查看~</p>
<p>Github，世界上最大的交友平台，琳琅满目的开源软件，上百人一起协作编写一份代码文件都不在话下，区区 md 而已。通过各种开源软件，可以在 1 小时内，让你的 md 文档被全世界人和人看到。</p>
