<template><div><h1 id="关于本站-yao-测试" tabindex="-1"><a class="header-anchor" href="#关于本站-yao-测试"><span>关于本站 Yao:测试</span></a></h1>
...
<p>Github 地址: <a href="https://github.com/mo7cc/BlogSource" target="_blank" rel="noopener noreferrer">https://github.com/mo7cc/BlogSource</a></p>
<blockquote>
<p>注: 本站并非开源，但是我写了一个同步脚本，会定期将博客的源码同步至上述公开仓库中。通过上述仓库中的源码可以顺畅编译出本博客的全部公开内容。</p>
</blockquote>
<blockquote>
<p>本博客搭建的技术细节可以参考: <RouteLink to="/Yao/tutorial/vuepress-hope/">本博客搭建指南</RouteLink></p>
</blockquote>
...
<figure><img src="@source/Yao/blogme/image/顶部导航栏.png" alt="顶部菜单 和 播放器 " tabindex="0" loading="lazy"><figcaption>顶部菜单 和 播放器 </figcaption></figure>
<p>还做了一个站点地图页面，可以直接访问本站已经发布的所有文章列表。</p>
<h3 id="宽屏兼容" tabindex="-1"><a class="header-anchor" href="#宽屏兼容"><span>宽屏兼容</span></a></h3>
<figure><img src="@source/Yao/blogme/image/宽屏兼容.png" alt="宽屏兼容" tabindex="0" loading="lazy"><figcaption>宽屏兼容</figcaption></figure>
...
<figure><img src="@source/Yao/blogme/image/夜晚模式.png" alt="夜晚模式" tabindex="0" loading="lazy"><figcaption>夜晚模式</figcaption></figure>
...
<figure><img src="@source/Yao/blogme/image/common.png" alt="评论区截图" tabindex="0" loading="lazy"><figcaption>评论区截图</figcaption></figure>
<blockquote>
<p>建议使用 Github 登录。</p>
</blockquote>
...
<h2 id="缘落" tabindex="-1"><a class="header-anchor" href="#缘落"><span>缘落</span></a></h2>
...
<blockquote>
<p>查看<RouteLink to="/Yao/favorite/links/document.html">本站用到的相关技术</RouteLink>，除此之外，网站的运营还涉及到 SEO ，流量推广，PWA 等等知识。如果你在中国大陆，想让自己的站点稳定的运行，还得了解基本的法律法规和管理条例以及备案技巧。</p>
</blockquote>
...
<figure><img src="@source/Yao/blogme/image/weekly.jpg" alt="这是图片" tabindex="0" loading="lazy"><figcaption>这是图片</figcaption></figure>
...
<p><a href="http://blog2.mo7.cc" target="_blank" rel="noopener noreferrer">Hexo 制作的博客</a> <br>
...
<h2 id="vuepress-theme-hope" tabindex="-1"><a class="header-anchor" href="#vuepress-theme-hope"><span>vuepress-theme-hope</span></a></h2>
