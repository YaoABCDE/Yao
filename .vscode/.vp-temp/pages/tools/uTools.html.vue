<template><div><h1 id="utools" tabindex="-1"><a class="header-anchor" href="#utools"><span>uTools</span></a></h1>
...
<h2 id="一个截屏翻译软件引发惨案" tabindex="-1"><a class="header-anchor" href="#一个截屏翻译软件引发惨案"><span>一个截屏翻译软件引发惨案</span></a></h2>
<p>在 windows 下有一个神器： <code v-pre>有道词典</code><br>
...
<p>其内部实现了一个叫做 <code v-pre>关键字</code> 的调用逻辑，每个插件都可以使用关键字来调用其它的关键字，一个插件可以有多个关键字。所有插件之间都是可以相互进行调用的。</p>
<p>于是就出现了各种组合，比如：<br>
<code v-pre>截图插件</code> + <code v-pre>OCR 识别插件</code> + <code v-pre>翻译插件</code> = <strong>截屏翻译功能</strong><br>
<code v-pre>截图插件</code> + <code v-pre>二维码解析插件</code> = <strong>扫码功能</strong> (PC 能扫码了，喜极而泣)<br>
<code v-pre>文本提取</code> + <code v-pre>网址精灵</code> = <strong>一键收藏网址</strong><br>
<code v-pre>文件提取</code> + <code v-pre>PDF转换器</code> = <strong>一键转换 PDF 文件</strong><br>
<code v-pre>文件提取</code> + <code v-pre>图片压缩</code> = <strong>一键压缩本地图片</strong><br>
<code v-pre>文件提取</code> + <code v-pre>搜索插件</code> = <strong>一键搜索本地文件</strong><br>
.....</p>
...
目前 uTools 插件市场 400 + 各类插件，他们组合搭配起来基本上可以<code v-pre>[一键]</code>解决你 90%以上的快捷问题。</p>
<p>自从有了 uTools ，我把电脑上大部分快捷键都取消了，并且卸载了一大票工具类软件。后台只需要运行一个工具类软件，那就是 <code v-pre>uTools</code>。</p>
...
<h2 id="软件的使用演示" tabindex="-1"><a class="header-anchor" href="#软件的使用演示"><span>软件的使用演示</span></a></h2>
<BiliBili bvid="BV11x4y1T7iR" /><p>录制的比较粗糙，可以直接去 B 站观看高清视频。</p>
...
<h2 id="付费" tabindex="-1"><a class="header-anchor" href="#付费"><span>付费</span></a></h2>
<p>免费的 uTools 已经够用了，三年年会员费用才 180 软妹币(我果断买了三年的)。</p>
<blockquote>
<p>免费和付费的区别仅仅在于使用过的插件设置，数据是否可以云同步。</p>
</blockquote>
<div class="hint-container info">
<p class="hint-container-title">相见恨晚</p>
<p>感觉自己在寻找各种趁手工具上面浪费了大量的时间，就仅仅只是为了能让使用电脑的体验好那么一丢丢。但是 <code v-pre>uTolls</code> 无论是从产品设计还是程序架构上，都可以说是「快捷工具终结者」。<br>
快捷工具就应该长这样。</p>
<p>uTools 之于电脑，<br>
就像 VSCode 之于前端一样。</p>
<p>而且，它的插件生态一定会像 VSCode 一样越来越大。我可以放心的把自己的使用习惯交给它。</p>
<blockquote>
<p>世界上只分为两种人： <code v-pre>用过 uTools 的和不知道 uTools 的</code>。</p>
</blockquote>
<p>身为一个前端开发者，我也非常乐意吧自己开发的功能对接到这个平台上面去。</p>
</div>
</div></template>
