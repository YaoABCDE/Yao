    ...
    !function(e, t) {
      ...
      return function(e) {
        ...
        var i = /mobile/i.test(window.navigator.userAgent), a = { secondToTime: function(e2) {
          ...
          if (document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement) for (; null !== n2 && n2 !== e2; ) t2 += n2.offsetLeft, n2 = n2.offsetParent;
          else for (; null !== n2; ) t2 += n2.offsetLeft, n2 = n2.offsetParent;
          return t2 - i2;
        }, getElementViewTop: function(e2, t2) {
          for (var n2, i2 = e2.offsetTop, a2 = e2.offsetParent; null !== a2; ) i2 += a2.offsetTop, a2 = a2.offsetParent;
          ...
          return function(e3) {
            ...
            if (Array.isArray(e3)) {
              for (var t2 = 0, n2 = Array(e3.length); t2 < e3.length; t2++) n2[t2] = e3[t2];
              return n2;
            }
        ...
        void 0 === (a = "function" == typeof (i = function() {
          if ("object" === ("undefined" == typeof window ? "undefined" : r(window)) && void 0 !== document.querySelectorAll && void 0 !== window.pageYOffset && void 0 !== history.pushState) {
            var e2 = function(e3, t3, n3, i2) {
              ...
              if ("number" == typeof t3) var o = parseInt(t3);
              else var o = function(e3, t4) {
            ...
            return document.addEventListener("DOMContentLoaded", function() {
              for (var e3, t3 = document.querySelectorAll('a[href^="#"]:not([href="#"])'), i2 = t3.length; e3 = t3[--i2]; ) e3.addEventListener("click", n2, false);
            }), t2;
          }
        ...
        var l = function() {
          ...
          return i(e2, [{ key: "bindEvents", value: function() {
            ...
            if (this.player.events.trigger("listremove", { index: e3 }), this.audios[e3]) if (this.audios.length > 1) {
              ...
              for (var n2 = e3; n2 < t2.length; n2++) t2[n2].getElementsByClassName("aplayer-list-index")[0].textContent = n2;
        ...
        var a = function() {
          ...
          return i(e2, [{ key: "on", value: function(e3, t2) {
            ...
            if (this.events[e3] && this.events[e3].length) for (var n2 = 0; n2 < this.events[e3].length; n2++) this.events[e3][n2](t2);
        ...
        var s = function() {
          ...
          return a(e2, [{ key: "show", value: function() {
            ...
            var t2 = this;
            if (!this.parsed[e3]) if (this.async) {
            ...
            } else this.player.list.audios[e3].lrc ? this.parsed[e3] = this.parse(this.player.list.audios[e3].lrc) : this.parsed[e3] = [["00:00", "Not available"]];
            ...
            if (e3) {
              for (var t2 = (e3 = e3.replace(/([^\]^\n])\[/g, function(e4, t3) {
                ...
                if (r2) for (var s2 = r2.length, l = 0; l < s2; l++) {
        ...
        (function(t2) {
          ...
          a.$escape = function(e2) {
            ...
            if (Array.isArray(e2)) for (var n2 = 0, i2 = e2.length; n2 < i2; n2++) t3(e2[n2], n2);
            else for (var a2 in e2) t3(e2[a2], a2);
          }, e.exports = a;
        }).call(this, n(4));
      }, function(e, t, n) {
        var i = n(2);
        ...
        Object.defineProperty(t, "__esModule", { value: true }), t.default = function(e2) {
          ...
          for (var n2 in t2) t2.hasOwnProperty(n2) && !e2.hasOwnProperty(n2) && (e2[n2] = t2[n2]);
        ...
        function l(e2) {
          ...
          if ((i === o || !i) && setTimeout) return i = setTimeout, setTimeout(e2, 0);
          try {
            return i(e2, 0);
          } catch (t2) {
            try {
        ...
        function y() {
          if (!p) {
            ...
            u = null, p = false, function(e3) {
              if (a === clearTimeout) return clearTimeout(e3);
              if ((a === s || !a) && clearTimeout) return a = clearTimeout, clearTimeout(e3);
              try {
                a(e3);
              } catch (t3) {
                try {
        ...
        (function(t2) {
          ...
          function r(e2) {
            ...
            if ("function" != typeof e2) throw new TypeError("not a function");
            this._state = 0, this._handled = false, this._value = void 0, this._deferreds = [], c(e2, this);
          }
          function o(e2, t3) {
            for (; 3 === e2._state; ) e2 = e2._value;
            0 !== e2._state ? (e2._handled = true, r._immediateFn(function() {
              ...
              if (null !== n3) {
                ...
                s(t3.promise, i2);
              } else (1 === e2._state ? s : l)(t3.promise, e2._value);
          ...
          function s(e2, t3) {
            try {
              ...
              if (t3 && ("object" === (void 0 === t3 ? "undefined" : n2(t3)) || "function" == typeof t3)) {
                var i2 = t3.then;
                if (t3 instanceof r) return e2._state = 3, e2._value = t3, void u(e2);
                if ("function" == typeof i2) return void c((a2 = i2, o2 = t3, function() {
          ...
          function u(e2) {
            ...
            for (var t3 = 0, n3 = e2._deferreds.length; t3 < n3; t3++) o(e2, e2._deferreds[t3]);
            e2._deferreds = null;
          }
          function c(e2, t3) {
            var n3 = false;
          ...
          r.prototype.catch = function(e2) {
            ...
            return new r(function(t3, i2) {
              if (!e2 || void 0 === e2.length) throw new TypeError("Promise.all accepts an array");
              var a2 = Array.prototype.slice.call(e2);
              if (0 === a2.length) return t3([]);
              var r2 = a2.length;
              function o2(e3, s3) {
                try {
                  if (s3 && ("object" === (void 0 === s3 ? "undefined" : n2(s3)) || "function" == typeof s3)) {
                    var l2 = s3.then;
                    if ("function" == typeof l2) return void l2.call(s3, function(t4) {
                      o2(e3, t4);
                    }, i2);
                  }
                  a2[e3] = s3, 0 == --r2 && t3(a2);
              ...
              for (var s2 = 0; s2 < a2.length; s2++) o2(s2, a2[s2]);
            });
            ...
            return new r(function(t3, n3) {
              for (var i2 = 0, a2 = e2.length; i2 < a2; i2++) e2[i2].then(t3, n3);
            });
        ...
        var m = [], g = function() {
          ...
          return i(e2, [{ key: "initAudio", value: function() {
            ...
            }, n2 = 0; n2 < this.events.audioEvents.length; n2++) t2(n2);
            ...
            }, 100), this.template.skipPlayButton.innerHTML = o.default.pause), this.timer.enable("loading"), this.options.mutex) for (var t2 = 0; t2 < m.length; t2++) this !== m[t2] && m[t2].pause();
